...
if(isset($_POST["submit"])){
    $transaksi = query("SELECT * FROM transaksi WHERE tanggal >='$_POST[tanggal_awal]' AND tanggal<='$_POST[tanggal_akhir]' and id != 1037 ORDER BY id ASC");
} else {
    $transaksi = query("SELECT * FROM transaksi WHERE tanggal=curdate() ORDER BY id DESC");
}
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <a href="transaksi.php"><button type="button" class="btn btn-outline-success  width-md waves-effect waves-light">Hari Ini</button></a>
                                <a href="transaksi-month.php"><button type="button" class="btn btn-outline-success width-md waves-effect waves-light">Bulan Ini</button></a>
                                ...
                                <a href="transaksi-search.php"><button type="button" class="btn btn-success width-md waves-effect waves-light">Cari</button></a>
                            </div>
                        </div>
                        <br>
