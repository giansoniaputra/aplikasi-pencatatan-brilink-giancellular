...
$transaksi = query("SELECT * FROM transaksi WHERE id != 1037 ORDER BY id DESC");
...
if (isset($_POST["submit"])) {
	if (tambahTransaksi($_POST) > 0) {
		...
		<script>
			...
			document.location.href= 'transaksi-all.php'
		</script>
		";
    }else {
		echo "
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mt-3 mt-md-0">
                                ...
                                <a href="transaksi.php"><button type="button" class="btn btn-success width-md waves-effect waves-light">Semua</button></a>
