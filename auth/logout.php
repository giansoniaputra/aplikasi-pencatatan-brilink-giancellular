...
$hai = query("SELECT * FROM user WHERE username = '$_SESSION[username]'");

?>
<?php foreach($hai as $ha) : ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h3>See you again <br> <h2><?= $ha["nama_user"]; ?></h2></h3>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Back to <a href="session-destroy.php" class="text-dark ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
