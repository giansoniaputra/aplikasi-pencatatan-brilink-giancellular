                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="auth-register.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" id="nama_user" placeholder="Enter your name" name="nama_user" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat" class="form-control" id="alamat" cols="10" rows="4" required></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="no_hp" class="form-label">Phone Number</label>
                                        <input class="form-control" type="text" id="no_hp" required placeholder="Enter your Phone Number" name="no_hp">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="password" required id="password2" placeholder="Enter your password" name="password2">
                                    </div>
                                    <div class="mb-3">
                                        <label for="gambar" class="form-label">Upload Gambar</label>
                                        <input class="form-control" type="file" required id="gambar" name="gambar">
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted">Already have account?  <a href="login.php" class="text-dark ms-1"><b>Sign In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
