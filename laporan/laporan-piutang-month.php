...
include 'session.php';
    ...
    $sql = query("SELECT * FROM transaksi WHERE status = 'BELUM LUNAS' AND month(tanggal)=month(curdate()) AND year(tanggal)=year(curdate()) OR status = 'PINJAMAN' AND month(tanggal)=month(curdate()) AND year(tanggal)=year(curdate()) ORDER BY id DESC");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mt-3 mt-md-0">
                                ...
                                <a href="laporan-piutang-month.php"><button type="button" class="btn btn-success width-md waves-effect waves-light">Bulan Ini</button></a>
                        ...
                        <div class="row">
                        <h3 class="page-title-main">LAPORAN PIUTANG (BULAN INI)</h3>
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
