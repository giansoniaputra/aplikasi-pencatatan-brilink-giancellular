...
include 'session.php';
    ...
    $sql = query("SELECT * FROM transaksi WHERE status = 'BELUM LUNAS' OR status = 'PINJAMAN' ORDER BY id DESC");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mt-3 mt-md-0">
                                ...
                                <a href="laporan-piutang-all.php"><button type="button" class="btn btn-success width-md waves-effect waves-light">Semua</button></a>
