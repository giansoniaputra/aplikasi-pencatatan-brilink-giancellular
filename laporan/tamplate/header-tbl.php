...
$profiles = query("SELECT * FROM user WHERE username = '$_SESSION[username]'");
        ...
        <div id="wrapper">
            ...
            <div class="navbar-custom">
                    ...
                    <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                        ...
                        <li>
                            <h2 class="page-title-main">Laporan</h2>
                        </li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="email">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="laporan-all.php">Saldo</a>
                                        </li>
                                        <li>
                                            <a href="laporan-piutang.php">Piutang</a>
                                        </li>
                                        <li>
                                            <a href="cetak-laporan.php">Cetak Laporan</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
