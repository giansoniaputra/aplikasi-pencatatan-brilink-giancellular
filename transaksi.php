...
$transaksi = query("SELECT * FROM transaksi WHERE tanggal=curdate() and id != 1037 ORDER BY id DESC");
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="mt-3 mt-md-0">
                                <a href="transaksi.php"><button type="button" class="btn btn-success width-md waves-effect waves-light">Hari Ini</button></a>
